...
//	}
	...
	private void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
...
#if UNITY_4
		var width = (int)cam.pixelWidth;
		var height = (int)cam.pixelHeight;
		var dsWidth = (int)cam.pixelWidth / downsampleFactor;
		var dsHeight = (int)cam.pixelHeight / downsampleFactor;
#endif
#if UNITY_5
		...
		var bufferA = RenderTexture.GetTemporary(dsWidth, dsHeight, 0);
		...
		{
			var bufferB = RenderTexture.GetTemporary(dsWidth, dsHeight, 0);
			var bufferC = RenderTexture.GetTemporary(dsWidth, dsHeight, 0);
			var bufferD = RenderTexture.GetTemporary(dsWidth, dsHeight, 0);
